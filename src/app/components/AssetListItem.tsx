...
const AssetListItem: React.FC<AssetListItemProps> = ({ resource }) => {
  ...
  return (
    <div
      className={`flex flex-col border-b border-[#3B75A9] transition-all duration-300 relative`}
      style={{ minHeight: "180px" }} // Set a minimum height for consistent layout
    >
              ...
              {resource.Contact_Email && (
                <p className="whitespace-normal break-words">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="md:hover:text-[#1E79C8] transition ease-in-out duration-300"
                  >
                    {resource.Contact_Email}
                  </a>
                </p>
