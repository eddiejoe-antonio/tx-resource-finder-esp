...
export const orgFilterData: FilterData = {
    ...
    options: [
      ...
      },
      {
        type: 'Organization_Sub_Type',
        checked: false,
        value: 'Hospital u otro proveedor de servicios médicos',
        label: 'Hospital u otro proveedor de servicios médicos',
      },
      {
        type: 'Organization_Sub_Type',
        checked: false,
    ...
    options: [
      {
        ...
        value: 'Adultos mayores (más de 60 años)',
        label: 'Adultos mayores (más de 60 años)',
        checked: false,
      },
      {
        type: 'Asset_Covered_Population',
        value: 'Familias de bajos ingresos',
        label: 'Familias de bajos ingresos',
        checked: false,
      },
      {
        type: 'Asset_Covered_Population',
      ...
      {
        type: 'Asset_Covered_Population',
        value: 'Personas con discapacidades',
        label: 'Personas con discapacidades',
        checked: false,
      },
      {
        type: 'Asset_Covered_Population',
        value: 'Personas que no pueden hablar o escribir en inglés con fluidez',
        label: 'Personas que no pueden hablar o escribir en inglés con fluidez',
        checked: false,
      },
      {
        type: 'Asset_Covered_Population',
        value: 'Personas de comunidades étnicas y raciales minoritarias',
        label: 'Personas de comunidades étnicas y raciales minoritarias',
        checked: false,
      },
      {
        type: 'Asset_Covered_Population',
        value: 'Comunidades rurales',
        label: 'Comunidades rurales',
        checked: false,
      },
      {
        type: 'Asset_Covered_Population',
        value: 'Personas afectadas por la justicia',
        label: 'Personas afectadas por la justicia',
        checked: false,
      },
    ],
}
export const typeFilterData: FilterData = {
  ...
  options: [
    {
      value: 'Buscar clases y ayuda con las habilidades digitales',
      label: 'Buscar clases y ayuda con las habilidades digitales',
      checked: false,
      type: 'Live_Site_Category',
      icon: BookOpenIcon,
    },
    {
      value: 'Obtener un dispositivo o una computadora',
      label: 'Obtener un dispositivo o una computadora',
      checked: false,
      type: 'Live_Site_Category',
      icon: DeviceTabletIcon,
    },
    {
      value: 'Buscar ofertas de internet a bajo costo',
      label: 'Buscar ofertas de internet a bajo costo',
      checked: false,
      type: 'Live_Site_Category',
      icon: WifiIcon,
    },
    {
      value: 'Buscar un centro con computadoras públicas',
      label: 'Buscar un centro con computadoras públicasr',
      checked: false,
      type: 'Live_Site_Category',
